...
class PeminjamanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('project.peminjaman.index', compact('peminjaman', 'search'));
    }

    public function create()
    {
        $buku = Buku::all();
        return view('project.peminjaman.create', compact('buku'));
    }
    ...
    public function store(Request $request)
{
    ...
    public function show($id)
    {
        ...
        return view('project.peminjaman.show', compact('peminjaman'));
    }
    ...
    public function edit($id)
    {
        $peminjaman = Peminjaman::with('bukus')->findOrFail($id);
        $buku = Buku::all();
        return view('project.peminjaman.edit', compact('peminjaman', 'buku'));
    }
