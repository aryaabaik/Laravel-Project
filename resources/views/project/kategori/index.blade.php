                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('kategori.show', $kategori->id) }}" class="btn btn-outline-dark btn-sm">Show</a>
                            <a href="{{ route('kategori.edit', $kategori->id) }}" class="btn btn-outline-success btn-sm">Edit</a>
